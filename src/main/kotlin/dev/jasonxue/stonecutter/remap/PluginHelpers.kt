...
internal fun Project.requireStonecutter() {
    check(pluginManager.hasPlugin("dev.kikugie.stonecutter")) {
        "Plugin 'dev.jasonxue.stonecutter.remap' requires 'dev.kikugie.stonecutter' to be applied explicitly."
    }
}
